-- AmIAnAI Database Schema - Clean Version
...
-- Personas table (depends on users)
...
-- Conversation participants table (depends on conversations and personas)
...
-- Messages table (depends on conversations and personas, NO self-reference)
...
-- Analytics tables (depend on conversations and personas)
...
-- Full-text search index (commented out for now - can be added later)
