...
describe('Navigation Structure (Option B)', () => {
  ...
  describe('Home Page (/) - Dashboard', () => {
    it('should show dashboard content without auto-connecting to matches', () => {
      ...
      expect(screen.getByText('Welcome to Robot Orchestra')).toBeInTheDocument();
      expect(screen.getByText('Start Playing')).toBeInTheDocument();
    });

    it('should not auto-connect to WebSocket when visiting home page', () => {
      ...
      // Assert: Should NOT auto-connect
