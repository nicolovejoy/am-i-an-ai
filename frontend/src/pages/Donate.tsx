      ...
      <div className="terminal">
        ...
        <div className="text-gray-300">
          <p className="text-xl mb-6 font-mono">
            <span className="text-neon-blue">&gt;</span> Your resource contributions enable
            continued operation and enhancement of this detection network.
          </p>

          <div className="bg-dark-blue bg-opacity-70 border border-neon-blue p-4 mb-8">
            <p className="text-neon-blue font-mono">
              <span className="text-terminal-green">NOTE:</span> This is a simulation. In
              production, secure payment processing would be integrated.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="mb-4">
              As AI systems evolve rapidly, maintaining effective detection algorithms requires
              continuous development. Your contributions directly support:
            </p>
            <ul className="list-disc pl-5 mb-4 space-y-2">
              <li className="text-neon-blue">Algorithm enhancement and accuracy optimization</li>
              <li className="text-neon-purple">Advanced feature development and deployment</li>
              <li className="text-neon-blue">Network integrity and accessibility preservation</li>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              <div className="neon-border rounded-md p-4 text-center bg-opacity-30 bg-medium-blue hover:bg-opacity-50 transition-all">
                <h3 className="text-xl font-semibold font-mono mb-2 text-neon-blue">SINGLE</h3>
                <p className="text-gray-400 mb-4">One-time system resource allocation</p>
                <button className="sci-fi-button w-full">Contribute Once</button>
              </div>
              ...
              <div className="neon-border rounded-md p-4 text-center bg-opacity-30 bg-medium-blue hover:bg-opacity-50 transition-all relative">
                ...
                <h3 className="text-xl font-semibold font-mono mb-2 text-neon-purple">RECURSIVE</h3>
                <p className="text-gray-400 mb-4">Monthly recurring resource allocation</p>
              ...
              <div className="neon-border rounded-md p-4 text-center bg-opacity-30 bg-medium-blue hover:bg-opacity-50 transition-all">
                <h3 className="text-xl font-semibold font-mono mb-2 text-neon-pink">ANNUAL</h3>
                <p className="text-gray-400 mb-4">Yearly resource allocation commitment</p>
          ...
          <div className="mb-8">
            ...
            <p className="mb-4">
              If resource allocation is not possible, consider these alternative support methods:
            </p>
