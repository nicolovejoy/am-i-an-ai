...
function App() {
  ...
  // Calculate the margin based on sidebar width from design system
  const sidebarWidth = componentStyles.sidebar.width;
  ...
  return (
    <Router>
      <div className="min-h-screen bg-dark-blue text-white flex">
        ...
        {/* Sidebar */}
        {sidebarVisible && <Sidebar isLoggedIn={isLoggedIn} />}

        {/* Main content */}
        <div
          className={`flex flex-col flex-1 transition-all duration-300`}
          style={{ marginLeft: sidebarVisible ? sidebarWidth : '0' }}
        >
          <NavMenu
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
              <div className="md:flex md:items-center md:justify-between">
                <div className="text-center md:text-left">
                  <p className="text-gray-400">&copy; 2025 Am I an AI? All rights reserved.</p>
                </div>
