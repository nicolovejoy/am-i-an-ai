    ...
    <div className="min-h-screen bg-slate-50" data-page="about">
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border">
            <h3 className="text-lg font-semibold text-slate-900 mb-3">🎵 The Musical Metaphor</h3>
            <p className="text-slate-700 mb-3">
              Like a jazz ensemble, each participant contributes their unique voice to create something 
              greater than the sum of its parts. You&apos;re not just playing—you&apos;re composing together.
            </p>
            <p className="text-slate-600">
              The voting phase asks: can you recognize your fellow human musicians in this digital orchestra?
            </p>
          </div>
