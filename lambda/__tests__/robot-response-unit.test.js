...
describe('Robot Response Unit Tests', () => {
    ...
    it('should generate personality-based responses', () => {
        const personalities = ['curious_student', 'witty_professional', 'friendly_skeptic'];
    ...
    it('should transition to voting after all responses collected', () => {
        ...
        const allCollected = matchManager.submitResponse(matchId, humanParticipant.identity, 'Test response');
